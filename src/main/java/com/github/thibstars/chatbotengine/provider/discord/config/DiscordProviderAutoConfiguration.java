...
package com.github.thibstars.chatbotengine.provider.discord.config;
...
@Configuration
@AllArgsConstructor
public class DiscordProviderAutoConfiguration {

    private final DiscordTokenAuthentication discordTokenAuthentication;

    @Bean
    @ConditionalOnMissingBean(DiscordProvider.class)
